  ...
  return (
    <div className="flex items-center gap-4 transition-all duration-500 hover:scale-105 group">
      <div className="relative">
        {/* Main Eye Icon with Professional Styling */}
        <div className="relative z-10">
          <Eye size={40} className="text-blue-600 dark:text-blue-400 transition-all duration-300 group-hover:text-blue-500 dark:group-hover:text-blue-300" />
        </div>
        
        {/* Professional Background Ring */}
